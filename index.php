...
<body>
            ...
            <hr>
                <p class="mb-0">
                    <ul class="pnr-details">
                        ...
                        <li>
                            <strong>Travel Motive : </strong>
                            <?php echo $travel_purpose; ?>
                        </li>
                        <li>
    ...
    <header>
        <nav>
            <div>
                    <a href="#" class="nav-item nav-logo">M A S</a>
            ...
            <div>
                ...
                <a href="#" class="reset nav-item" data-bs-toggle="modal" data-bs-target="#ResetModal"><i class="fas fa-sign-out-alt" style="margin-right: 0.4rem;"></i>Change Password</a>

                <a href="#pnr-enquiry" class="pnr nav-item"><i class="fas fa-search-plus"></i>PNR Enquiry</a>
            </div>
            <div>
            </div>
        </nav>
    ...
    <section id="home">
        <div id="route-search-form">
            <h1>Mas Transportation</h1>

            <p class="text-center">Welcome to MASTRANSPORTATION KENYA System. Login now to manage Van tickets and much more. OR, simply scroll down to check the Ticket status using Passenger Name Record (PNR number)</p>
...
<script>
   $(document).ready(function () {
    ...
    $("#ResetPassword").submit(function (event) {
        ...
        $.ajax({
            type: "POST",
            url: "interface/resetPasswordFromOutside.php", // Replace with the actual path to your reset_password.php file
            data: formData,
            ...
            error: function (jqXHR, textStatus, errorThrown) {
                // Display the error response in the modal
                $("#responseMessage").text("Error: " + jqXHR.responseText);
                // Show the modal
                $("#responseModal").modal("show");
