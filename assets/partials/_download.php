<?php
    ...
    if(isset($_GET["pnr"]))
    {
        ...
        $travel_purpose = get_from_table($conn, "bookings", "booking_id", $pnr, "travel_purpose");
                ...
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="col-md-6"><em><b> Number Plate:</b></em></h4></td>
                        ...
                        <tr>
                           ...
                           <td class="col-md-6"><em><b>Travel Motive:</b></em></h4></td>
                   
                           <td class="col-md-6 text-center"><?php echo $travel_purpose; ?></td>
