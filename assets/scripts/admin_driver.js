        ...
        editRow.innerHTML = `
            <td colspan="5">
                <form class="editRouteForm d-flex justify-content-between" action="${evt.target.dataset.link}" method="POST">
                    ...
                    <input type="text" class="form-control" name="dname" value="${evt.target.dataset.name}">
                    <input type="text" class="form-control dphone" name="dphone" value="${evt.target.dataset.phone}">
                    <input type="text" class="form-control busno" name="busno" placeholder="Bus Number" value="${evt.target.dataset.busno}">
